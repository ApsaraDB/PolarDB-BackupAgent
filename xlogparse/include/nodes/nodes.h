...
typedef enum NodeTag
{
	...
	T_AssertOpState,
    /* POLAR fastann */
	T_BitmapAnnPath,			/* Path */
	T_BitmapAnnScan,			/* Plan node */
	T_BitmapAnnScanState,		/* Plan node state*/

	T_ResortMergeAppendPath,
	T_ResortMergeAppend,			/* Plan node for resort merge */
	T_ResortMergeAppendState,		/* Plan node for resort merge state */
	/* POLAR end */
	/* POLAR px */
	T_SplitUpdateState,
	/* POLAR end */

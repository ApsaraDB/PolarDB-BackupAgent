...
#define CSNLogControlLock (&MainLWLockArray[46].lock)
#define CommitSeqNoLock (&MainLWLockArray[47].lock)
#define POLARResourceManagerLock (&MainLWLockArray[48].lock)
#define ConsensusLock (&MainLWLockArray[49].lock)
#define ShareInputScanLock (&MainLWLockArray[50].lock)

#define NUM_INDIVIDUAL_LWLOCKS		51

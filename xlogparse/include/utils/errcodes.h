...
#define ERRCODE_WARNING_PX_INTERCONNECTION MAKE_SQLSTATE('0','1','M','0','2')
...
#define ERRCODE_PX_FEATURE_NOT_YET MAKE_SQLSTATE('0','A','M','0','1')
#define ERRCODE_PX_FEATURE_NOT_CONFIGURED MAKE_SQLSTATE('0','A','M','0','2')
...
#define ERRCODE_PX_OPERATION_CANCELED MAKE_SQLSTATE('2','5','M','0','1')
...
#define ERRCODE_PX_INTERCONNECTION_ERROR MAKE_SQLSTATE('5','8','M','0','1')
...
/* Class PX - Internal Error */
#define ERRCODE_PX_INTERNAL_ERROR MAKE_SQLSTATE('P','X','0','0','0')

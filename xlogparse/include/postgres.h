...
#include "storage/polar_storage_partial.h" 
/* POLAR Ganos end */
/* ----------------------------------------------------------------
...
#define VARTAG_SIZE(tag) \
	((tag) == VARTAG_INDIRECT ? sizeof(varatt_indirect) : \
	 ...
	 VARTAG_IS_ONDISK_PARTIAL(tag) ? sizeof(varatt_external) :/* POLAR Ganos: Toast partial */ \
...
#define VARATT_IS_EXTERNAL_ONDISK(PTR) \
	...
	VARTAG_IS_ONDISK_PARTIAL(VARTAG_EXTERNAL(PTR))))/* POLAR Ganos: Toast partial */
 ...
 *   POLAR Ganos: Toast partial 
 */
/* Tag is VARTAG_ONDISK_PARTIAL? */
#define VARATT_IS_EXTERNAL_ONDISK_PARTIAL(PTR) \
	(VARATT_IS_EXTERNAL(PTR) && (VARTAG_IS_ONDISK_PARTIAL(VARTAG_EXTERNAL(PTR))))

/* If tag is VARTAG_ONDISK_PARTIAL, get length of partial internal */
#define VARSIZE_EXTERNAL_ONDISK_PARTIAL_INTERNAL(PTR) \
		(VARTAG_ONDISK_PARTIAL_INTERNAL_SIZE(VARTAG_EXTERNAL(PTR)))

/* If tag is VARTAG_ONDISK_PARTIAL, get total length of inline */
#define VARSIZE_EXTERNAL_ONDISK_PARTIAL(PTR) \
		(VARSIZE_EXTERNAL(PTR) + VARTAG_ONDISK_PARTIAL_INTERNAL_SIZE(VARTAG_EXTERNAL(PTR)))
/* POLAR Ganos end */

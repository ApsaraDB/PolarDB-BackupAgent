...
#define PG_VERSION "11.9"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 110009

/* POLARDB px version as a str */
#define PX_VERSION_STR "PolarDB PX version 1.1"

/* POLARDB px version as a number */
#define PX_VERSION_NUMBER 1.1

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 11.9 (POLARDB 11.9)"
...
/* Define to 1 to build with PX optimizer. (--enable-polar-px) */
/* #undef USE_PX */
...
/* Define to 1 to compile with minimal mode. (--enable-polar-minimal) */
#define POLAR_MINIMAL 1

/* Define to 1 to compile with polar tests. (--enable-polar-inject-tests) */
#define POLAR_INJECT_TESTS 1

/* Define to 1 to build ORCA in debug (GPOS_DEBUG=1) */
/* #undef GPOS_DEBUG */

/* POLAR: Define to 1 if use cas. */
/* #undef POLAR_USE_CAS */

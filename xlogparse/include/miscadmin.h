...
/* POLAR RESOURCE MANAGER */
extern PGDLLIMPORT volatile bool ProcDumpMCXTPending;
/* POLADR end */
/* POLADR px */
...
/* POLAR: True in backends where throttling can be performed. */
extern bool polar_resource_throttling_ok;
...
/* POLAR: get database id */
extern Oid polar_get_databseid(const char *database_name);
extern PGDLLIMPORT volatile bool DirtyThrottlePending;
extern PGDLLIMPORT volatile bool CPUThrottlePending;

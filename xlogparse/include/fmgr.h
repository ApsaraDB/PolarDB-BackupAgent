...
extern struct varlena *polar_detoast_datum_internal(struct varlena *datum);
#define PG_DETOAST_DATUM_INTERNAL(datum) \
	polar_detoast_datum_internal((struct varlena *) DatumGetPointer(datum))
/* POLAR Ganos end */

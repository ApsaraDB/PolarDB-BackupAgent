...
# case 33: 
# action: start wal backup using script -> do full backup using script -> insert some data -> backup wals -> recovery through full backup and wals using script
...
rm ~/genlogfile
echo ""
read -p "wait wals to be backuped, enter to continue" 

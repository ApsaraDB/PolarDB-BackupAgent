...
# case 16: 
# action: do full backup -> insert some data -> do block backup -> recovery through full backup and block backup/ wals
...
curl "http://$testnode:1888/manager/StartBackup" -d '{

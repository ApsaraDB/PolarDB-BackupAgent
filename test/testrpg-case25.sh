...
script="/usr/local/polardb_o_backup_tool_current/bin/regular-increbackup-fs2http-cm-simple.sh"
...
script="/usr/local/polardb_o_backup_tool_current/bin/backupctl-multifs2http-cm-simple.sh"
echo Ali165243 | sudo -S sed -i "s/cmgateway=\"\"/cmgateway=\"47.118.56.58:5500\"/g" $script
echo Ali165243 | sudo -S sed -i "s/polardbdata=\"\"/polardbdata=\"\/mnt\/polardb_cluster_mycluster\"/g" $script
echo Ali165243 | sudo -S sed -i "s/pgdata=\"\"/pgdata=\"\/var\/local\/polardb\/clusters\/mycluster\"/g" $script
echo Ali165243 | sudo -S sed -i "s/dst=\"\"/dst=\"47.118.41.173:8080\"/g" $script
...
script="\/usr\/local\/polardb_o_backup_tool_current\/bin\/regular-deltabackup-multifs2http-cm-simple.sh"
...
script="/usr/local/polardb_o_backup_tool_current/bin/recovery2fs-pitr-byhttp-cm.sh"
echo Ali165243 | sudo -S sed -i "s/cmgateway=\"\"/cmgateway=\"47.118.56.58:5500\"/g" $script

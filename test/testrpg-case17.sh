...
curl "http://$testnode:5500/manager/StartBackup" -d '{
  "ManagerAddr": "'$testnode':1888",
  "BackupMachineList": ["http://'$testnode':1888"],
  "InstanceID": "'$Instance'",
  "BackupID": "increbk",
  "BackupType": "Incremental",
  "BackupJobID": "default",
  "CallbackURL": "http://127.0.0.1:1889",
  "DBNodes": ["'$testnode'", "118.178.122.235"],
  "BackupAccount": {"User": "user_rep","Password": "cGdzcWwK","Endpoint": "'$testnode'","Port": "1521"},
  "Filesystem":"fs",

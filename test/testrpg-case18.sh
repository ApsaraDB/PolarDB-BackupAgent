...
# case 18: 
# action: do full backup -> insert some data -> HA -> insert some data on new rw -> do block backup -> recovery through full backup and block backup/ wals
...
curl "http://$testnode:5500/manager/StartBackup" -d '{
  "BackupMachineList": ["http://'$newrwnode':1888"],
  "InstanceID": "'$Instance'",
  ...
  "BackupJobID": "default",
  "CallbackURL": "http://127.0.0.1:1889",
  "BackupAccount": {"User": "user_rep","Password": "cGdzcWwK","Endpoint": "'$newrwnode'","Port": "1521"},
  "Filesystem":"fs",
  "BackupStorageSpace": {"StorageType":"http", "Locations":{"http": {"Endpoint": "'$httpaddr'"}}},
  "BackupFolder": "/mnt/polardb_cluster_mycluster",
  "DBClusterMetaDir":"/var/local/polardb/clusters/mycluster"

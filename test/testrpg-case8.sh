...
# case 8: 
# action: do full backup -> insert tuples -> do block backup -> insert tuples -> do block backup -> insert tuples -> wal backup -> recovery through full backup and block backup and wals

...
# case 30: 
# action: do full backup -> insert some data -> do block backup and restart pg just before pgstopbackup function -> do block backup again -> recovery through full backup and block backup
...
echo '########## wait to restart pg ##########'
echo ""
read -p "enter to restart pg" 
pg_ctl restart -D $PGDATA
sleep 1
echo ""
read -p "wait the error occur" 

...
# case 21: 
# action: do full backup -> insert some data -> HA -> delete some data on new rw -> do block backup -> recovery through full backup and block backup/ wals
...
sleep 1
rm -rf ~/test.sql
echo 'excute sql done, output should be 501!'
cat ~/genlogfile
rm ~/genlogfile
echo ""
read -p "enter to continue" 

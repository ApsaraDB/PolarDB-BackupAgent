...
# case 28: 
# action: do full backup -> insert some data -> do block backup and abort after backup log -> do block backup again -> recovery through full backup and block backup
...
sleep 1
rm -rf ~/test.sql
echo 'excute sql done, output should be 11!'
cat ~/genlogfile
rm ~/genlogfile
echo ""
read -p "enter to continue" 